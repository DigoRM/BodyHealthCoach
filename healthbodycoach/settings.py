"""
Django settings for healthbodycoach project.
...
SECRET_KEY = 'django-insecure-8n1$nxj%(q2!2%nvf3*yqnl-lfdo97h-g@=nr@nfy2xh#^d27#'
...
CSRF_TRUSTED_ORIGINS = ['https://sennateam.up.railway.app/']
...
ROOT_URLCONF = 'healthbodycoach.urls'
...
WSGI_APPLICATION = 'healthbodycoach.wsgi.application'
...
DEFAULT_FROM_EMAIL = "SennaTeam <noreply@sennateam.com>"
